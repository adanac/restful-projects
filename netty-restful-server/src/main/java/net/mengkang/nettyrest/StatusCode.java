...
public class StatusCode {
    ...
    public static final int UPDATED_SUCCESS = 301;
    public static final int DELETED_SUCCESS = 401;
    ...
    static {
        ...
        codeMap.put(UPDATED_SUCCESS, "updated success");
        codeMap.put(DELETED_SUCCESS, "deleted success");
